                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <div class="p-6">
                                ...
                                <form action="admin.php?act=add_post" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="submit" value="Lưu và Đăng" name="themmoi" class="btn btn-success waves-effect waves-light">
                                           
                                        <button type="button"
                                            class="btn btn-danger waves-effect waves-light">Loại Bỏ</button>
                                            <button type="button"
                                            class="btn btn-danger waves-effect waves-light"><a href="admin.php?act=dstintuc">Danh Sách</a></button>
                                    </form>
                                    <script src="/eulalie/admin/ckeditor5/ckeditor.js"></script>
                                    <script>
                                        ClassicEditor
