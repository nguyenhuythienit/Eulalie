...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 12, 2022 lúc 03:05 PM
...
(201, 144, 'quốc việt', NULL, 'dep quá'),
(202, 21, 'xin chào', NULL, 'chào'),
(203, 10, 'thiên phúc', NULL, 'dep chai');
...
CREATE TABLE `lienhe` (
  ...
  `tepdinhkem` int(11) NOT NULL,
  `vanban` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(19, 'trunggg', '', 'voductrung.vn@gmail.com', '', '123', '', b'0');
...
--
ALTER TABLE `binhluan`
  MODIFY `mabl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;
...
--
ALTER TABLE `loai`
  MODIFY `idloai` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Mã Loại', AUTO_INCREMENT=25;
